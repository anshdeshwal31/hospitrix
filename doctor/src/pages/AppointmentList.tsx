...
export const AppointmentList = () => {
  ...
  return (
    <div className="w-[1100px] ml-5 xl:ml-20 flex flex-col gap-3" >
      <div className="text-2xl font-medium text-slate-800 mt-5">All Appointments</div>

      <div className="bg-slate-100  w-fit xl:w-[95%]">
        <div className="bg-blue-200 w-fit xl:w-full flex xl:justify-between text-slate-800 font-medium border-t-2 rounded-t-lg text-lg">
          <span className="w-[20px] xl:w-[50px] text-center py-2">#</span>
          <span className="w-[200px] px-3 py-2">Patient</span>
          {/* <span className="hidden xl:block  w-[80px] py-2">Payment</span> */}
        ...
        <div className="">
          {
            appointments.map((appointment:appointmentType, index: number) => { 
              ...
              return (
                <div className="flex xl:justify-between py-2 border border-slate-300">
